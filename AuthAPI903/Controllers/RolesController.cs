...
namespace AuthAPI903.Controllers
{
    ...
    public class RolesController : Controller
    {
        ...
        {
            // Obtener los roles primero
            var roles = await _roleManager.Roles.ToListAsync();

            // Crear una lista para almacenar los roles con el total de usuarios
            var roleResponses = new List<RoleResponseDto>();

            // Iterar sobre cada rol y obtener el número de usuarios en cada rol
